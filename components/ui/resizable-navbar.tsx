...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-[1400px] flex-row items-center justify-between self-start rounded-full bg-transparent px-4 py-2 lg:flex dark:bg-transparent",
  ...
  return (
    ...
    >
      <img
        ...
        height={30}
      />
      <span className="font-medium text-black dark:text-white">Ambition</span>
    </a>
  );
};
